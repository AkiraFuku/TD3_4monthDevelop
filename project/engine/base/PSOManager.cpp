...
D3D12_PRIMITIVE_TOPOLOGY_TYPE PSOManager::GetPrimitiveTopologyType(TopologyType type)
{
...
void PSOManager::CreatePso(const std::string& name, BlendMode blend, FillMode fill) {
    ...
    psoDesc.PrimitiveTopologyType = GetPrimitiveTopologyType(config.topologyType);
